...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('customer', '0003_alter_coustomers_mobile_coustemersaddress'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='customers',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='customer.customers'),
        ),
    ]
